...
import { FileText, Scale, AlertCircle, Pencil, BookOpen } from 'lucide-react';
    ...
    >
          ...
          <Card className="shadow-md hover:shadow-lg transition-all">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="mt-4 p-4 border border-primary/30 rounded-lg bg-primary/5 flex items-start gap-3">
                ...
                <p className="text-sm">
                  <strong>Learn more:</strong> Visit our <a href="https://blog.printify.com/order-process" className="text-primary hover:underline">blog post</a> on how we process and fulfill orders for a better understanding of our workflow.
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      >
        ...
        <p className="mt-4 text-sm">
          Read our <a href="https://blog.printify.com/legal" className="text-primary hover:underline">blog</a> for more information on legal considerations for print businesses
        </p>
      </motion.div>
    </motion.div>
  );
